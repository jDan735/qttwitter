...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 391, 591))
        self.tabWidget.setStyleSheet("width: ")
        self.tabWidget.setObjectName("tabWidget")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.label_3 = QtWidgets.QLabel(self.tab)
        self.label_3.setGeometry(QtCore.QRect(10, 140, 371, 31))
        font = QtGui.QFont()
        ...
        self.pushButton.setGeometry(QtCore.QRect(220, 90, 141, 41))
        font = QtGui.QFont()
        font.setFamily("Noto Sans Display")
        ...
        self.label_7.setGeometry(QtCore.QRect(30, 170, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_8.setGeometry(QtCore.QRect(120, 170, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_9.setGeometry(QtCore.QRect(100, 170, 21, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_10.setGeometry(QtCore.QRect(10, 170, 21, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.tabWidget_2.setGeometry(QtCore.QRect(0, 200, 381, 361))
        ...
        self.label.setGeometry(QtCore.QRect(0, 0, 381, 111))
        self.label.setStyleSheet("")
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.tab)
        self.label_2.setGeometry(QtCore.QRect(10, 40, 91, 91))
        self.label_2.setAutoFillBackground(False)
        self.label_2.setObjectName("label_2")
        self.frame_2 = QtWidgets.QFrame(self.tab)
        self.frame_2.setGeometry(QtCore.QRect(10, 40, 91, 91))
        ...
        self.label_4.setGeometry(QtCore.QRect(0, 0, 381, 111))
        self.label_4.setStyleSheet("")
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self.tab_2)
        self.label_5.setGeometry(QtCore.QRect(10, 40, 91, 91))
        self.label_5.setStyleSheet("")
        self.label_5.setScaledContents(True)
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(self.tab_2)
        self.label_6.setGeometry(QtCore.QRect(10, 140, 371, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_11.setGeometry(QtCore.QRect(10, 170, 41, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_12.setGeometry(QtCore.QRect(50, 170, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_13.setGeometry(QtCore.QRect(120, 170, 41, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_14.setGeometry(QtCore.QRect(160, 170, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.tabWidget_3.setGeometry(QtCore.QRect(0, 200, 381, 361))
        ...
        self.frame.setGeometry(QtCore.QRect(10, 40, 91, 91))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/default/img/app/Prefs_Fonts.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menuText.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/default/img/app/Action_Login.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionEnter_to_Twitter.setIcon(icon2)
        font = QtGui.QFont()
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/default/img/app/Server_NewsFeed.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/default/img/app/Action_GoBack_3_Large.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/default/img/app/App_TextSearch.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionFind_user.setIcon(icon5)
        self.actionFind_user.setObjectName("actionFind_user")
        self.actionFind_user_by = QtWidgets.QAction(MainWindow)
        self.actionFind_user_by.setIcon(icon5)
        self.actionFind_user_by.setObjectName("actionFind_user_by")
        self.actionFind_tweets_by = QtWidgets.QAction(MainWindow)
        self.actionFind_tweets_by.setIcon(icon5)
        self.actionFind_tweets_by.setObjectName("actionFind_tweets_by")
        self.actionIncrease = QtWidgets.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/default/img/app/List_Add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionIncrease.setIcon(icon6)
        self.actionIncrease.setObjectName("actionIncrease")
        self.actionReduce = QtWidgets.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/default/img/app/Action_Stop_1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionReduce.setIcon(icon7)
        self.actionReduce.setObjectName("actionReduce")
        self.actionDefault = QtWidgets.QAction(MainWindow)
        self.actionDefault.setIcon(icon1)
        self.actionDefault.setObjectName("actionDefault")
        self.actionAbout_QT = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/default/img/app/qt"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><img width=\"381\" height=\"111\" src=\":/@jDan734/img/@jDan734/600x200.jpg\"/></p></body></html>"))
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p align=\"justify\"><img width=91 src=\":/@jDan734/img/@jDan734/mAIV3fEU_400x400.jpg\"/></p></body></html>"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "@jDan734"))
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p><img width=\"381\" height=\"111\" src=\":/@navalny/img/@navalny/600x200\"/></p></body></html>"))
